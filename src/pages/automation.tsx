...
import { listAutomationRules, createAutomationRule, updateAutomationRule, deleteAutomationRule, listAIInsights, generateAIInsights, checkAutomationRules } from '../lib/storage-simple';
import type { AutomationRule, AIInsight } from '../lib/types';

export default function AutomationPage() {
  const [automationRules, setAutomationRules] = useState<AutomationRule[]>([]);
  const [aiInsights, setAiInsights] = useState<AIInsight[]>([]);
  const [activeTab, setActiveTab] = useState<'rules' | 'insights' | 'settings'>('rules');
  const [showRuleForm, setShowRuleForm] = useState(false);

  const refresh = () => {
    setAutomationRules(listAutomationRules());
    setAiInsights(listAIInsights());
  };
    ...
    <Layout>
      <div className="min-h-screen gradient-bg">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-2">Automation & AI Center</h1>
          <p className="text-white/80 text-lg">Intelligent business automation and insights</p>
        </div>
        ...
        <div className="card">
          <div className="flex space-x-4 mb-6">
            {[
              ...
              { key: 'settings', label: '⚙️ AI Settings', icon: '⚙️' }
            ].map(tab => (
              <button
                key={tab.key}
            ...
            <div className="card">
              <div className="flex flex-wrap gap-4 justify-between items-center">
                <div className="flex gap-3">
                  ...
                  <button onClick={createDefaultRules} className="btn-success">
          ...
          <div className="space-y-6">
            ...
            <div className="card">
              <div className="flex justify-between items-center">
                <h2 className="text-xl font-semibold text-gray-800">AI Business Insights</h2>
                <button onClick={generateInsights} className="btn">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                ...
                <div key={insight.id} className="card">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      ...
                      <p className="text-gray-600 capitalize">{insight.type.replace('_', ' ')}</p>
                    </div>
              ...
              {aiInsights.length === 0 && (
                <div className="col-span-2 text-center py-8 text-gray-500">
                  No AI insights available. Click "Generate New Insights" to analyze your business data.
                </div>
              )}
            </div>
          </div>
        ...
        {activeTab === 'settings' && (
          <div className="space-y-6">
            <div className="card">
              <h2 className="text-xl font-semibold text-gray-800 mb-6">AI & Automation Settings</h2>
