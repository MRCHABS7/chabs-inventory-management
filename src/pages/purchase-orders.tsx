        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="card text-center">
            <div className="text-2xl font-bold text-green-600">
              ${purchaseOrders.reduce((sum, po) => sum + (typeof po.total === 'number' ? po.total : 0), 0).toFixed(2)}
            </div>
              ...
              <tbody>
                {filteredPOs.map(po => (
                  <tr key={po.id}>
                    ...
                    <td className="font-medium">${typeof po.total === 'number' ? po.total.toFixed(2) : '0.00'}</td>
                    <td>
